...
mainbase ()
{
  ...
  <bb 3> [local count: 360938]:
  # q_120 = PHI <1(2), q_87(37)>
  # r_122 = PHI <r_55(D)(2), r_124(37)>

  <bb 4> [local count: 1804255]:
  # p_121 = PHI <1(3), p_86(36)>
  # r_123 = PHI <r_122(3), r_47(36)>
  begin_58 = clock ();
  a = 1.0e+0;
  b = 1.0e+0;
  c = 1.0e+0;
  ...
  <bb 5> [local count: 405416]:
  k = 1.0e+2;
  goto <bb 8>; [100.00%]

  <bb 6> [local count: 1398839]:
  if (p_121 == 2)
    goto <bb 7>; [22.47%]
  else
    goto <bb 9>; [77.53%]

  <bb 7> [local count: 314319]:
  k = 2.5e+2;

  <bb 8> [local count: 1804255]:
  b.0_113 = b;
  k.1_114 = k;
  if (b.0_113 <= k.1_114)
    goto <bb 15>; [89.00%]
  ...
  # b.0_117 = PHI <b.0_113(8), b.0_1(25)>
  # k.1_118 = PHI <k.1_114(8), k.1_2(25)>
  a.2_116 = a;
  if (k.1_118 >= a.2_116)
    goto <bb 16>; [89.00%]
  else
  ...
  # a.2_119 = PHI <a.2_116(15), a.2_3(24)>
  _4 = a.2_119 * a.2_119;
  x = _4;
  _5 = b.0_117 * b.0_117;
  y = _5;
  ...
  <bb 18> [local count: 1073741825]:
  _7 = k.1_118 * 1.4199999999999999289457264239899814128875732421875e+0;
  _8 = ceil (_7);
  ...
  <bb 27> [local count: 405416]:

  <bb 28> [local count: 1804255]:
  # r_43 = PHI <r_123(26), 3.0000000260770320892333984375e-3(27)>
  if (p_121 == 2)
    goto <bb 29>; [22.47%]
  else
    goto <bb 30>; [77.53%]
  ...
  # r_44 = PHI <r_43(28), 3.50000001490116119384765625e-2(29)>
  if (p_121 == 3)
    goto <bb 31>; [22.47%]
  else
    goto <bb 32>; [77.53%]
  ...
  # r_45 = PHI <r_44(30), 2.730000019073486328125e-1(31)>
  if (p_121 == 4)
    goto <bb 33>; [22.47%]
  else
    goto <bb 34>; [77.53%]
  ...
  # r_46 = PHI <r_45(32), 2.224999904632568359375e+0(33)>
  if (p_121 == 5)
    goto <bb 35>; [22.47%]
  else
    goto <bb 36>; [77.53%]
  ...
  # r_47 = PHI <r_46(34), 7.535999774932861328125e+0(35)>
  _20 = (double) r_47;
