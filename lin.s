...
.LBB1_55:
	...
	callq	_ZStlsIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_St5_Setw
	movq	-32(%rbp), %rdi
	movss	3996(%rdi), %xmm0       # xmm0 = mem[0],zero,zero,zero
	movq	%rax, %rdi
	callq	_ZNSolsEf
	movq	%rax, %rdi
	movabsq	$.L.str, %rsi
...
# %bb.0:
	...
	movq	%rax, -16(%rbp)
	movabsq	$_ZSt4cout, %rdi
	movabsq	$_ZZ9timestampvE11time_buffer, %rsi
	callq	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc
	movq	%rax, %rdi
	movabsq	$.L.str, %rsi
	callq	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc
...
.Lfunc_end15:
	...
	.cfi_endproc
                                        # -- End function
	.section	.text.startup,"ax",@progbits
	.p2align	4, 0x90         # -- Begin function _GLOBAL__sub_I_linpack.cpp
	.type	_GLOBAL__sub_I_linpack.cpp,@function
_GLOBAL__sub_I_linpack.cpp:             # @_GLOBAL__sub_I_linpack.cpp
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end16:
	.size	_GLOBAL__sub_I_linpack.cpp, .Lfunc_end16-_GLOBAL__sub_I_linpack.cpp
	.cfi_endproc
                                        # -- End function
...
.L.str.5:
	.asciz	"  Datatype: Single precision\n"
	.size	.L.str.5, 30

	.type	.L.str.6,@object        # @.str.6
.L.str.6:
	.asciz	"  Matrix order N               = "
	.size	.L.str.6, 34

	.type	.L.str.7,@object        # @.str.7
.L.str.7:
	.asciz	"  Leading matrix dimension LDA = "
	.size	.L.str.7, 34
...
.L.str.11:
	.asciz	"     Norm. Resid      Resid           MACHEP         X[1]          X[N]\n"
	.size	.L.str.11, 73
...
.L.str.13:
	.asciz	"      Factor     Solve      Total     MFLOPS       Unit      Cray-Ratio\n"
	.size	.L.str.13, 73
...
.L.str.15:
	...
	.p2align	3
	.quad	_GLOBAL__sub_I_linpack.cpp
	...
	.addrsig_sym _GLOBAL__sub_I_linpack.cpp
