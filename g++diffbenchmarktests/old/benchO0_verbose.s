...
# benchmark.cpp:52: 						if (c == pow(powcheck, 2))
	...
	movl	$0, %edx	#, tmp171
	ucomisd	%xmm0, %xmm1	# c.15_21, _20
	cmovne	%edx, %eax	# tmp170,, tmp171, retval.13_114
# benchmark.cpp:52: 						if (c == pow(powcheck, 2))
	testb	%al, %al	# retval.13_114
	je	.L17	#,
...
# benchmark.cpp:64: 				a = 1;
	movsd	.LC0(%rip), %xmm0	#, tmp175
	movsd	%xmm0, a(%rip)	# tmp175, a
# benchmark.cpp:65: 				++b;
	movsd	b(%rip), %xmm1	# b, b.22_32
	movsd	.LC0(%rip), %xmm0	#, tmp176
...
# benchmark.cpp:67: 			clock_t end = clock();
	call	clock	#
	movq	%rax, -40(%rbp)	# tmp177, end
# benchmark.cpp:68: 			double elapsed_secs = double(end - begin) / CLOCKS_PER_SEC;
	movq	-40(%rbp), %rax	# end, tmp178
	subq	-32(%rbp), %rax	# begin, _34
# benchmark.cpp:68: 			double elapsed_secs = double(end - begin) / CLOCKS_PER_SEC;
	cvtsi2sdq	%rax, %xmm0	# _34, _35
# benchmark.cpp:68: 			double elapsed_secs = double(end - begin) / CLOCKS_PER_SEC;
	movsd	.LC7(%rip), %xmm1	#, tmp180
	divsd	%xmm1, %xmm0	# tmp180, tmp179
	movsd	%xmm0, -48(%rbp)	# tmp179, elapsed_secs
# benchmark.cpp:69: 			timetake[p - 1] = elapsed_secs;
	movl	-16(%rbp), %eax	# p, tmp181
	subl	$1, %eax	#, _36
# benchmark.cpp:69: 			timetake[p - 1] = elapsed_secs;
	cltq
	movsd	-48(%rbp), %xmm0	# elapsed_secs, tmp183
	movsd	%xmm0, -96(%rbp,%rax,8)	# tmp183, timetake
# benchmark.cpp:71: 			if (p == 1)
	cmpl	$1, -16(%rbp)	#, p
	jne	.L24	#,
# benchmark.cpp:72: 				r = 0.003;
	movss	.LC8(%rip), %xmm0	#, tmp184
...
# benchmark.cpp:78: 				r = 2.225;
	movss	.LC11(%rip), %xmm0	#, tmp187
	movss	%xmm0, -20(%rbp)	# tmp187, r
.L27:
# benchmark.cpp:79: 			if (p == 5)
	cmpl	$5, -16(%rbp)	#, p
	jne	.L28	#,
# benchmark.cpp:80: 				r = 7.536;
	movss	.LC12(%rip), %xmm0	#, tmp188
	movss	%xmm0, -20(%rbp)	# tmp188, r
.L28:
# benchmark.cpp:81: 			score[p - 1] = 200 * (r / timetake[p - 1]);
	cvtss2sd	-20(%rbp), %xmm0	# r, _37
# benchmark.cpp:81: 			score[p - 1] = 200 * (r / timetake[p - 1]);
	movl	-16(%rbp), %eax	# p, tmp189
	subl	$1, %eax	#, _38
# benchmark.cpp:81: 			score[p - 1] = 200 * (r / timetake[p - 1]);
	cltq
...
# benchmark.cpp:83: 			stagetime[p - 1] = stagetime[p - 1] + 0.2 * elapsed_secs;
	movl	-16(%rbp), %eax	# p, tmp197
	subl	$1, %eax	#, _52
# benchmark.cpp:83: 			stagetime[p - 1] = stagetime[p - 1] + 0.2 * elapsed_secs;
	cltq
	movsd	stagetime(,%rax,8), %xmm1	# stagetime, _53
# benchmark.cpp:83: 			stagetime[p - 1] = stagetime[p - 1] + 0.2 * elapsed_secs;
	movsd	-48(%rbp), %xmm2	# elapsed_secs, tmp199
	movsd	.LC14(%rip), %xmm0	#, tmp200
	mulsd	%xmm2, %xmm0	# tmp199, _54
# benchmark.cpp:83: 			stagetime[p - 1] = stagetime[p - 1] + 0.2 * elapsed_secs;
	movl	-16(%rbp), %eax	# p, tmp201
	subl	$1, %eax	#, _55
# benchmark.cpp:83: 			stagetime[p - 1] = stagetime[p - 1] + 0.2 * elapsed_secs;
...
# benchmark.cpp:84: 			cout << p * 4 + (q - 1) * 20 << " % complete!" << '\n'; 
	movl	-12(%rbp), %eax	# q, tmp203
	leal	-1(%rax), %edx	#, _57
# benchmark.cpp:84: 			cout << p * 4 + (q - 1) * 20 << " % complete!" << '\n'; 
	movl	%edx, %eax	# _57, tmp204
	sall	$2, %eax	#, tmp204
	addl	%eax, %edx	# tmp204, _58
	movl	-16(%rbp), %eax	# p, tmp205
	addl	%edx, %eax	# _58, _59
# benchmark.cpp:84: 			cout << p * 4 + (q - 1) * 20 << " % complete!" << '\n'; 
	sall	$2, %eax	#, _60
	movl	%eax, %esi	# _60,
	movl	$_ZSt4cout, %edi	#,
...
# benchmark.cpp:85: 			cout << "Time taken for that stage:- " << timetake[p - 1] << '\n';
	cltq
	movsd	-96(%rbp,%rax,8), %xmm0	# timetake, _65
	movq	%rdx, %rdi	# _63,
	call	_ZNSolsEd	#
# benchmark.cpp:85: 			cout << "Time taken for that stage:- " << timetake[p - 1] << '\n';
	movl	$10, %esi	#,
...
# benchmark.cpp:86: 			cout << "Score obtained for that stage:- " << score[p - 1] * 5 << '\n';
	...
	movq	%rax, %rdx	#, _67
# benchmark.cpp:86: 			cout << "Score obtained for that stage:- " << score[p - 1] * 5 << '\n';
	movl	-16(%rbp), %eax	# p, tmp208
	subl	$1, %eax	#, _68
# benchmark.cpp:86: 			cout << "Score obtained for that stage:- " << score[p - 1] * 5 << '\n';
	cltq
	movss	score(,%rax,4), %xmm1	# score, _69
# benchmark.cpp:86: 			cout << "Score obtained for that stage:- " << score[p - 1] * 5 << '\n';
	movss	.LC18(%rip), %xmm0	#, tmp210
	mulss	%xmm1, %xmm0	# _69, _70
	movq	%rdx, %rdi	# _67,
	call	_ZNSolsEf	#
# benchmark.cpp:86: 			cout << "Score obtained for that stage:- " << score[p - 1] * 5 << '\n';
	movl	$10, %esi	#,
...
.L46:
	...
	cmpq	$1, %rax	#, D.48251
	je	.L43	#,
	movq	%rbx, %rax	# tmp112, D.48252
	movq	%rax, %rdi	# D.48252,
	call	_Unwind_Resume	#
.LEHE2:
.L43:
...
.L47:
	...
	call	_ZNSt9exceptionD1Ev	#
	call	__cxa_end_catch	#
	movq	%rbx, %rax	# tmp116, D.48253
	movq	%rax, %rdi	# D.48253,
.LEHB4:
	call	_Unwind_Resume	#
.LEHE4:
.L48:
